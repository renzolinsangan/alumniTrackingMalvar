...
<body>
  <form action="#" method="POST">
    ...
    <?php include ("sql/studyingSQL.php"); ?>
    <div class="container">
            ...
            <div class="card-body">
              <div class="row mt-3">
                ...
                <div class="col-12 mb-3">
                  <?php include ("table/studyingTable.php") ?>
                  ...
                  <div class="card-body ps-4" style="padding: 20px;">
                    ...
                    <div class="row mb-4">
                      <div class="col-md-6 mb-3">
                        ...
                        <select name="gender" class="form-select" id="select-control" disabled>
                  ...
                  <div class="card-body ps-4" style="padding: 20px;">
                    <div class="row mt-3 mb-4">
                      ...
                      <div class="col-12 mb-4">
                        ...
                        <select class="form-select" name="answer15" id="select-control" disabled>
                    ...
                    <div class="row mt-3 mb-4">
                      ...
                      <div class="col-12 mb-4">
                        ...
                        <textarea name="feedback2" class="form-control" id="input-control"
                          ...
                          placeholder="Write any comment or suggestion"
