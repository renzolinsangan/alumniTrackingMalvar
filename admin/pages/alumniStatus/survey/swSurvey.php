                    ...
                    <div class="row mt-3 mb-4">
                      ...
                      <div class="col-12 mb-4">
                        ...
                        <input type="text" class="form-control" name="answer1" id="input-control"
                          value="<?php echo $answer1 ?>" disabled>
                      </div>
                      <!-- NUMBER 2 QUESTION -->
                      <div class="col-12 mb-4">
                        <h5>
                        ...
                        <input type="text" class="form-control" name="answer2" id="input-control"
                          placeholder="Enter your degree program" value="<?php echo $answer2 ?>" disabled>
                      </div>
                      <!-- NUMBER 3 QUESTION -->
                      <div class="col-12 mb-4">
                        <h5>
                        ...
                        <select name="answer3" class="form-select" id="select-control" disabled>
                      ...
                      <div class="col-12 mb-4">
                        ...
                        <select name="answer4" class="form-select" id="select-control" disabled>
                      ...
                      <div class="col-12 mb-4">
                        ...
                        <select name="answer6" class="form-select" id="select-control" disabled>
                      ...
                      <div class="col-12 mb-4">
                        ...
                        <select name="answer8" class="form-select" id="select-control" disabled>
                      ...
                      <div class="col-12 mb-4">
                        ...
                        <select name="answer9" class="form-select" id="select-control" disabled>
                      ...
                      <div class="col-12 mb-4">
                        ...
                        <select name="answer10" class="form-select" id="select-control" disabled>
                      ...
                      <div class="col-12 mb-4">
                        ...
                        <select name="answer11" class="form-select" id="select-control" disabled>
                      ...
                      <div class="col-12 mb-4">
                        ...
                        <select name="answer12" class="form-select" id="select-control" disabled>
                      ...
                      <div class="col-12 mb-4">
                        ...
                        <select name="answer13" class="form-select" id="select-control" disabled>
                      ...
                      <div class="col-12 mb-2">
                        ...
                        <input type="text" name="answer14" class="form-control" id="input-control"
                          value="<?php echo $answer14 ?>" disabled>
                      </div>
                    </div>
                  </div>
                </div>
                    ...
                    <div class="row mt-3 mb-4">
                      ...
                      <div class="col-12 mb-4">
                        ...
                        <input type="text" class="form-control" name="answer15" id="input-control"
                          value="<?php echo $answer15 ?>" disabled>
                      </div>
                      <!-- NUMBER 16 QUESTION -->
                      <div class="col-12 mb-4">
                        <h5>
                        ...
                        <select name="answer16" class="form-select" id="select-control" disabled>
                      ...
                      <div class="col-12 mb-4">
                        ...
                        <select name="answer17" class="form-select" id="select-control" disabled>
                      ...
                      <div class="col-12 mb-4">
                        ...
                        <select name="answer18" class="form-select" id="select-control" disabled>
                      ...
                      <div class="col-12 mb-4">
                        ...
                        <input type="text" class="form-control" name="answer20" id="input-control"
                          placeholder="Enter the location of the company" value="<?php echo $answer20 ?>" disabled>
                      </div>
                      <!-- NUMBER 21 QUESTION -->
                      <div class="col-12 mb-4">
                        <h5>
                        ...
                        <input type="text" class="form-control" name="answer21" id="input-control"
                          placeholder="Enter your designation/position" value="<?php echo $answer21 ?>" disabled>
                      </div>
                      <!-- NUMBER 22 QUESTION -->
                      <div class="col-12 mb-4">
                        <h5>
                        ...
                        <select name="answer22" class="form-select" id="select-control" disabled>
                      ...
                      <div class="col-12 mb-4">
                        ...
                        <select name="answer23" class="form-select" id="select-control" disabled>
                      ...
                      <div class="col-12 mb-4">
                        ...
                        <select name="answer24" class="form-select" id="select-control" disabled>
                      ...
                      <div class="col-12 mb-4">
                        ...
                        <select name="answer25" class="form-select" id="select-control" disabled>
                      ...
                      <div class="col-12 mb-4">
                        ...
                        <select name="answer26" class="form-select" id="select-control" disabled>
                      ...
                      <div class="col-12 mb-4">
                        ...
                        <select name="answer27" class="form-select" id="select-control" disabled>
                      ...
                      <div class="col-12 mb-4">
                        ...
                        <select name="answer28" class="form-select" id="select-control" disabled>
                      ...
                      <div class="col-12">
                        ...
                        <select name="answer29" class="form-select" id="select-control" disabled>
