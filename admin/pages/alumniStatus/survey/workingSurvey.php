...
<body>
  <form action="#" method="POST">
    ...
    <?php include ("sql/workingSQL.php"); ?>
    <div class="container">
            ...
            <div class="card-body">
              <div class="row mt-3">
                ...
                <div class="col-12 mb-3">
                  <?php include ("table/workingTable.php"); ?>
                    ...
                    <div class="row mt-3 mb-4">
                      ...
                      <div class="col-12 mb-4">
                        ...
                        <input type="text" class="form-control" name="answer6" id="input-control"
                          placeholder="Enter the location of the company" value="<?php echo $answer6 ?>" disabled>
                      </div>
                      <!-- NUMBER 7 QUESTION -->
                      <div class="col-12 mb-4">
                        <h5>
                        ...
                        <input type="text" class="form-control" name="answer7" id="input-control"
                          placeholder="Enter your designation/position" value="<?php echo $answer7 ?>" disabled>
                      </div>
                      <!-- NUMBER 8 QUESTION -->
                      <div class="col-12 mb-4">
                        <h5>
                      ...
                      <div class="col-12 mb-4">
                        ...
                        <select name="answer14" class="form-select" id="select-control" disabled>
                      ...
                      <div class="col-12 mb-4">
                        ...
                        <select name="answer15" class="form-select" id="select-control" disabled>
