...
include ("phpConnection/certificateDetails.php");
include ("phpConnection/certificateSubmit.php");
  ...
  <div class="container mb-5">
    <div class="main-card card">
      <div class="card-body">
        <div class="row mb-4">
          <div class="col-md-12">
            <div class="certificate-title card" style="border: none; padding: 20px;">
              <div class="card-body">
        ...
        <div class="row">
          <div class="col-md-12">
            <div class="certificate-body card" style="border: none; padding: 20px;">
              <div class="card-body">
                <div class="title row">
                    ...
                    <div class="col">
                      ...
                      <div class="row mb-4">
                        <div class="col-md-6">
                          ...
                          <select name="process" class="purpose form-select mt-2">
                      ...
                      <div class="row">
                        <div class="col text-end">
                          <button type="submit" class="btn" name="submitButton"
                            ...
                            <i class="bi bi-box-arrow-right"></i> Submit Request</button>
                        </div>
                      </div>
                    </div>
                  </div>
