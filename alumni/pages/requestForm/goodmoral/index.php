...
include ("phpConnection/goodmoralDetails.php");
include ("phpConnection/goodmoralSubmit.php");
  ...
  <div class="container mb-5">
    <div class="main-card card">
      <div class="card-body">
        <div class="row mb-4">
          <div class="col-md-12">
            <div class="goodmoral-title card" style="border: none;">
              <div class="card-body">
                <h1>Good Moral</h1>
        ...
        <div class="row">
          <div class="col-md-12">
            <div class="goodmoral-body card" style="border: none; padding: 20px;">
              <div class="card-body">
                <div class="title row">
