...
include ("phpConnection/othersDetails.php");
include ("phpConnection/othersSubmit.php");
  ...
  <div class="container mb-5">
    <div class="main-card card">
      <div class="card-body">
        <div class="row mb-4">
          <div class="col-md-12">
            <div class="others-title card" style="border: none;">
              <div class="card-body">
        ...
        <div class="row">
          <div class="col-md-12">
            <div class="others-body card" style="border: none; padding: 20px;">
              <div class="card-body">
                <div class="title row">
                  ...
                  <div class="body row mt-4 justify-content-between">
                    <div class="col">
                      ...
                      <div class="row mb-4">
                        ...
                        <div class="col-md-6">
                          <label for="others">Other Document</label>
                          <input type="text" class="form-control mt-2" name="document">
                        </div>
                      </div>
                      <div class="row mb-5">
                        <div class="col">
                      ...
                      <div class="row">
                        <div class="col text-end">
                          <button type="submit" class="btn" name="submitButton"
                            ...
                            <i class="bi bi-box-arrow-right"> Submit Request</i>
                          </button>
                        </div>
                      </div>
                    </div>
