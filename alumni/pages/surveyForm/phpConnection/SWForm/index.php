                  ...
                  <div class="card-body ps-4" style="padding: 20px;">
                    <div class="row mt-3 mb-4">
                      ...
                      <div class="col-12 mb-2">
                        ...
                        <input type="text" name="answer14" class="form-control" id="input-control" value="Yes" readonly>
                      </div>
                    </div>
                  </div>
                </div>
                  ...
                  <div class="card-body ps-4" style="padding: 20px;">
                    <div class="row mt-3 mb-4">
                      ...
                      <div class="col-12 mb-4">
                        ...
                        <input type="text" class="form-control" name="answer15" id="input-control" value="Yes" readonly>
                      </div>
                      <!-- NUMBER 16 QUESTION -->
                      <div class="col-12 mb-4">
                        <h5>
